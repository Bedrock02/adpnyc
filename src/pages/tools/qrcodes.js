...
const keywords = "QR Codes, digital code, qr, ADP, Advanced Digital Printing NYC, NYC printing";
      ...
      <>
        <Helmet
          ...
          meta={[
            {
              name: 'description',
              content: 'QR Codes. What are QR Codes? How can you use qr codes for your marketing and in digital printing' },
            {
              name: 'keywords',
              content: keywords },
          ]}
