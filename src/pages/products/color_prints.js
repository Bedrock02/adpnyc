...
const keywords = 'color prints, black and white prints, adp products, printing,\
      ...
      <>
        <Helmet
          ...
          meta={[
            {
              name: 'description',
              content: 'Prints as a product. Advanced Digital NYC offers\
               a basic but good quality paper for any print.'
            },
            {
              name: 'keywords',
              content: keywords },
